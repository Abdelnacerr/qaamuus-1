...
export const updateRequest = (state) => state.merge({ updating: true, changed:null })

// we've successfully updated the account settings
export const updateSuccess = (state,{changed}) => state.merge({ error: null,changed:true, updating: false })

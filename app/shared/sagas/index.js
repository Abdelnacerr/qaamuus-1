...
import { register,verification,ResendCode } from '../../modules/account/register/register.sagas'
import { forgotPassword, verificationPasswordReset,passwordReset } from '../../modules/account/password-reset/forgot-password.sagas'
...
import { updateProfile } from '../../modules/account/profile/profile.saga'
...
export default function* root() {
  yield all([
    ...
    takeLatest(RegisterTypes.VERIFICATION_REQUEST, verification, api),
    takeLatest(RegisterTypes.RESEND_CODE_REQUEST, ResendCode, api),
    
    takeLatest(ForgotPasswordTypes.PASSWORD_RESET_REQUEST, passwordReset, api),
    takeLatest(ForgotPasswordTypes.VERIFICATION_REQUEST_PASSWORD_RESET, verificationPasswordReset, api),
